...
namespace Feeder.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult ChangePassword() {
            LogFunctions.Info("AccountController.ChangePassword");
        ...
        public ActionResult ChangePassword(string currentPassword, string newPassword, string confirmPassword) {
            LogFunctions.Info("AccountController.ChangePassword with params");
        ...
        public ActionResult ChangePasswordSuccess() {
            LogFunctions.Info("AccountController.ChangePasswordSuccess");
        ...
        public ActionResult Login(string username, string password, bool rememberMe, string returnUrl) {
            LogFunctions.Info(string.Format("AccountController.Login({0}, {1}, {2})", username, rememberMe.ToString(), returnUrl));
        ...
        public ActionResult Logout() {
            LogFunctions.Info("AccountController.Logout");
        ...
        public ActionResult Register() {
            LogFunctions.Info("AccountController.Register");
        ...
        public ActionResult Register(string username, string email, string password, string confirmPassword) {
            LogFunctions.Info(string.Format("AccountController.Register({0})", username));
            ...
            if( ViewData.ModelState.IsValid ) {
                ...
                if( newUser != null ) {
                    //TODO: Initialize UserHistory for this user
